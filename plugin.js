...
function seedState(projects, stored) {
  const base = normalizeState(stored?.groups?.length ? stored : { groups: DEFAULT_GROUPS, assignments: {} })
...
function ProjectRow({ groups, onAssign, onOpen, project, selectedGroup }) {
  return jsxs('div', {
...
function GroupCard({ group, groups, onAssign, onDelete, onOpen, onRename, onToggle, projects, selected }) {
        ...
        (projects.length
          ? jsx('div', {
              children: projects.map(project =>
                jsx(
                  ProjectRow,
                  { groups, onAssign, onOpen, project, selectedGroup: selected[project.id] },
                  project.id
                )
              )
            })
...
function ProjectGroupsPage({ ctx }) {
          ...
          jsxs('div', {
            ...
            children: [
              ...
              jsx('p', {
                ...
                children: `${projects.length} Projects · groups are local to this Hermes Desktop profile`
              })
            ]
          }),
          jsx(Input, {
    ...
    ctx.registerMany([
      {
        ...
        render: () => jsx(ProjectGroupsPage, { ctx })
      },
      {
        id: 'nav',
